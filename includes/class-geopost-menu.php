...
class GeoPostMenu {
  public static function load() {
    ...
    add_filter('manage_' . GeoPost::POST_TYPE . '_posts_columns', array(__CLASS__, 'manage_posts_columns'), 99);
    add_action('manage_' . GeoPost::POST_TYPE . '_posts_custom_column', array(__CLASS__, 'manage_posts_custom_column'), 10, 2);
  ...
  public static function restrict_manage_posts() {
    ...
    $distances = array(10, 25, 50, 100, 250, 500);
